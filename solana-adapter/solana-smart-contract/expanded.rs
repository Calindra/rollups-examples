...
fn dispatch(
    ...
    match sighash {
        ...
        [141, 132, 233, 130, 168, 183, 10, 119] => {
            __private::__global::init_wallet(program_id, accounts, ix_data)
        }
        [163, 52, 200, 231, 140, 3, 69, 186] => {
            __private::__global::transfer(program_id, accounts, ix_data)
        }
        [219, 200, 88, 176, 158, 63, 253, 127] => {
            __private::__global::update(program_id, accounts, ix_data)
        }
...
mod __private {
    ...
    pub mod __global {
        ...
        pub fn initialize(
            ...
            ::solana_program::log::sol_log("Instruction[4]: Initialize");
        ...
        pub fn init_wallet(
            ...
            ::solana_program::log::sol_log("Instruction[4]: InitWallet");
            let ix = instruction::InitWallet::deserialize(&mut &ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::InitWallet = ix;
            let mut __bumps = std::collections::BTreeMap::new();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut remaining_accounts: &[AccountInfo] = accounts;
            let mut accounts = InitWallet::try_accounts(
                program_id,
                &mut remaining_accounts,
                ix_data,
                &mut __bumps,
        ...
        pub fn transfer(
            ...
            ::solana_program::log::sol_log("Instruction[4]: Transfer");
            let ix = instruction::Transfer::deserialize(&mut &ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::Transfer { amount, nonce } = ix;
            let mut __bumps = std::collections::BTreeMap::new();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut remaining_accounts: &[AccountInfo] = accounts;
            let mut accounts = TransferInstruction::try_accounts(
                program_id,
                &mut remaining_accounts,
                ix_data,
                &mut __bumps,
        ...
        pub fn update(
            ...
            ::solana_program::log::sol_log("Instruction[4]: Update");
            let ix = instruction::Update::deserialize(&mut &ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::Update { token, min_balance } = ix;
            let mut __bumps = std::collections::BTreeMap::new();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut remaining_accounts: &[AccountInfo] = accounts;
            let mut accounts = UpdateDAO::try_accounts(
                program_id,
                &mut remaining_accounts,
                ix_data,
                &mut __bumps,
        ...
        pub fn close_dao(
            ...
            ::solana_program::log::sol_log("Instruction[4]: CloseDao");
        ...
        pub fn validate_telegram_user(
            ...
            ::solana_program::log::sol_log("Instruction[4]: ValidateTelegramUser");
        ...
        pub fn validate_human(
            ...
            ::solana_program::log::sol_log("Instruction[4]: ValidateHuman");
...
pub mod solzen {
    ...
    pub fn initialize(
        ...
        ::solana_program::log::sol_log("Initializing...");
    ...
    pub fn init_wallet(ctx: Context<InitWallet>) -> Result<()> {
        ...
        let (vault_authority, _bump) = Pubkey::find_program_address(
            &[WALLET_PDA_SEED, ctx.accounts.mint.to_account_info().key.as_ref()],
            ctx.program_id,
        );
    ...
    pub fn transfer(
        ...
        ::solana_program::log::sol_log("Calling transfer...");
        token::transfer(cpi_ctx, amount).expect("transfer2 failed");
        ::solana_program::log::sol_log("Transfer success.");
        Ok(())
    }
    pub fn update(
        ...
        ::solana_program::log::sol_log("Updating...");
...
pub mod instruction {
    ...
    impl borsh::ser::BorshSerialize for InitWallet {
        fn serialize<W: borsh::maybestd::io::Write>(
            &self,
            writer: &mut W,
        ) -> ::core::result::Result<(), borsh::maybestd::io::Error> {
    ...
    impl borsh::de::BorshDeserialize for InitWallet {
        fn deserialize(
            buf: &mut &[u8],
        ) -> ::core::result::Result<Self, borsh::maybestd::io::Error> {
            Ok(Self {})
    ...
    impl anchor_lang::InstructionData for InitWallet {
        fn data(&self) -> Vec<u8> {
            let mut d = [141, 132, 233, 130, 168, 183, 10, 119].to_vec();
            d.append(&mut self.try_to_vec().expect("Should always serialize"));
            d
        }
    }
    ...
    impl anchor_lang::InstructionData for Update {
        fn data(&self) -> Vec<u8> {
            let mut d = [219, 200, 88, 176, 158, 63, 253, 127].to_vec();
            d.append(&mut self.try_to_vec().expect("Should always serialize"));
            d
        }
    }
...
pub mod accounts {
    ...
    pub use crate::__client_accounts_update_dao::*;
    pub use crate::__client_accounts_transfer_instruction::*;
    pub use crate::__client_accounts_validate_human::*;
    pub use crate::__client_accounts_init_dao::*;
    pub use crate::__client_accounts_init_wallet::*;
    ...
    'info: 'info,
{
    ...
    fn try_accounts(
        ...
        ::solana_program::log::sol_log("Deserialize instruction, if declared.");
        ...
        ::solana_program::log::sol_log("Deserialize each account.");
        ...
        *accounts = &accounts[1..];
        ...
        ::solana_program::log::sol_log("Execute accounts constraints.");
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info> for UpdateDAO<'info>
where
    'info: 'info,
{
    #[inline(never)]
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for UpdateDAO<'info>
where
    'info: 'info,
{
    fn to_account_infos(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for UpdateDAO<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for UpdateDAO<'info>
where
    'info: 'info,
{
    fn exit(
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_update_dao {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`UpdateDAO`].
    pub struct UpdateDAO {
        pub zendao: anchor_lang::solana_program::pubkey::Pubkey,
        pub founder: anchor_lang::solana_program::pubkey::Pubkey,
        pub system_program: anchor_lang::solana_program::pubkey::Pubkey,
    }
    impl borsh::ser::BorshSerialize for UpdateDAO
    where
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for UpdateDAO {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_update_dao {
    use super::*;
    /// Generated CPI struct of the accounts for [`UpdateDAO`].
    pub struct UpdateDAO<'info> {
        pub zendao: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub founder: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub system_program: anchor_lang::solana_program::account_info::AccountInfo<
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info> for TransferInstruction<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        ::solana_program::log::sol_log("Deserialize instruction, if declared.");
        ::solana_program::log::sol_log("Deserialize each account.");
        let program_signer: AccountInfo = anchor_lang::Accounts::try_accounts(
                program_id,
                accounts,
                ix_data,
                __bumps,
            ...
            .map_err(|e| e.with_account_name("program_signer"))?;
        let authority: AccountInfo = anchor_lang::Accounts::try_accounts(
                program_id,
                accounts,
                ix_data,
                __bumps,
        ...
        let from: anchor_lang::accounts::account::Account<TokenAccount> = anchor_lang::Accounts::try_accounts(
                program_id,
                accounts,
                ix_data,
                __bumps,
        ...
        if !from.to_account_info().is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
        ...
        if !token_program.to_account_info().executable {
            return Err(
                anchor_lang::error::Error::from(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for TransferInstruction<'info>
where
    'info: 'info,
{
    fn to_account_infos(
        ...
        let mut account_infos = ::alloc::vec::Vec::new();
        account_infos.extend(self.program_signer.to_account_infos());
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for TransferInstruction<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
        let mut account_metas = ::alloc::vec::Vec::new();
        account_metas.extend(self.program_signer.to_account_metas(None));
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for TransferInstruction<'info>
where
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.to, program_id)
            .map_err(|e| e.with_account_name("to"))?;
        anchor_lang::AccountsExit::exit(&self.from, program_id)
            .map_err(|e| e.with_account_name("from"))?;
        Ok(())
    }
}
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_transfer_instruction {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`TransferInstruction`].
    pub struct TransferInstruction {
        pub program_signer: anchor_lang::solana_program::pubkey::Pubkey,
    ...
    impl borsh::ser::BorshSerialize for TransferInstruction
    where
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
        ...
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.program_signer, writer)?;
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for TransferInstruction {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_transfer_instruction {
    use super::*;
    /// Generated CPI struct of the accounts for [`TransferInstruction`].
    pub struct TransferInstruction<'info> {
        pub program_signer: anchor_lang::solana_program::account_info::AccountInfo<
            'info,
        >,
    ...
    impl<'info> anchor_lang::ToAccountMetas for TransferInstruction<'info> {
        fn to_account_metas(
            ...
            account_metas
                .push(
                    anchor_lang::solana_program::instruction::AccountMeta::new_readonly(
                        anchor_lang::Key::key(&self.program_signer),
                        false,
                    ),
                );
            account_metas
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for TransferInstruction<'info> {
        fn to_account_infos(
            ...
            let mut account_infos = ::alloc::vec::Vec::new();
            account_infos
                .push(anchor_lang::ToAccountInfo::to_account_info(&self.program_signer));
            account_infos
            ...
            account_infos.push(anchor_lang::ToAccountInfo::to_account_info(&self.from));
            account_infos
                .push(anchor_lang::ToAccountInfo::to_account_info(&self.token_program));
            account_infos
                .push(anchor_lang::ToAccountInfo::to_account_info(&self.system_program));
            account_infos
        }
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info> for InitWallet<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        let escrow_wallet = &accounts[0];
        *accounts = &accounts[1..];
        let user_sending: Signer = anchor_lang::Accounts::try_accounts(
                program_id,
                accounts,
                ix_data,
                __bumps,
            ...
            .map_err(|e| e.with_account_name("user_sending"))?;
        let mint: anchor_lang::accounts::account::Account<Mint> = anchor_lang::Accounts::try_accounts(
                program_id,
                accounts,
                ix_data,
        ...
        let __anchor_rent = Rent::get()?;
        let (__pda_address, __bump) = Pubkey::find_program_address(
            &[b"wallet".as_ref(), mint.key().as_ref()],
            program_id,
        );
        __bumps.insert("escrow_wallet".to_string(), __bump);
        let escrow_wallet: anchor_lang::accounts::account::Account<TokenAccount> = {
            if !false
                || AsRef::<AccountInfo>::as_ref(&escrow_wallet).owner
                    == &anchor_lang::solana_program::system_program::ID
            {
                let payer = user_sending.to_account_info();
                let __current_lamports = escrow_wallet.lamports();
                if __current_lamports == 0 {
                    let lamports = __anchor_rent
                        .minimum_balance(anchor_spl::token::TokenAccount::LEN);
                    let cpi_accounts = anchor_lang::system_program::CreateAccount {
                        from: payer.to_account_info(),
                        to: escrow_wallet.to_account_info(),
                    };
                    let cpi_context = anchor_lang::context::CpiContext::new(
                        system_program.to_account_info(),
                        cpi_accounts,
                    ...
                    let cpi_accounts = anchor_lang::system_program::Allocate {
                        account_to_allocate: escrow_wallet.to_account_info(),
                    };
                    let cpi_context = anchor_lang::context::CpiContext::new(
                        system_program.to_account_info(),
                        cpi_accounts,
                    ...
                    let cpi_accounts = anchor_lang::system_program::Assign {
                        account_to_assign: escrow_wallet.to_account_info(),
                    };
                    let cpi_context = anchor_lang::context::CpiContext::new(
                        system_program.to_account_info(),
                        cpi_accounts,
            ...
            let pa: anchor_lang::accounts::account::Account<TokenAccount> = anchor_lang::accounts::account::Account::try_from_unchecked(
                    &escrow_wallet,
                )
                .map_err(|e| e.with_account_name("escrow_wallet"))?;
            if false {
                if pa.mint != mint.key() {
                    return Err(
                        anchor_lang::error::Error::from(
                            ...
                            .with_account_name("escrow_wallet")
                            .with_pubkeys((pa.mint, mint.key())),
                    );
                }
                if pa.owner != user_sending.key() {
                    return Err(
                        anchor_lang::error::Error::from(
                                anchor_lang::error::ErrorCode::ConstraintTokenOwner,
                            )
                            .with_account_name("escrow_wallet")
                            .with_pubkeys((pa.owner, user_sending.key())),
                    );
                }
            }
            pa
        };
        if escrow_wallet.key() != __pda_address {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintSeeds,
                    )
                    .with_account_name("escrow_wallet")
                    .with_pubkeys((escrow_wallet.key(), __pda_address)),
            );
        }
        if !escrow_wallet.to_account_info().is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
        ...
        if !__anchor_rent
            .is_exempt(
                escrow_wallet.to_account_info().lamports(),
                escrow_wallet.to_account_info().try_data_len()?,
            )
        {
            return Err(
                anchor_lang::error::Error::from(
        ...
        if !user_sending.to_account_info().is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
                    .with_account_name("user_sending"),
            );
        }
        if !(token_program.key == &token::ID) {
            return Err(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for InitWallet<'info>
where
    'info: 'info,
{
    fn to_account_infos(
        ...
        account_infos.extend(self.user_sending.to_account_infos());
        account_infos.extend(self.mint.to_account_infos());
        account_infos.extend(self.token_program.to_account_infos());
        account_infos.extend(self.system_program.to_account_infos());
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for InitWallet<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
        ...
        account_metas.extend(self.user_sending.to_account_metas(None));
        account_metas.extend(self.mint.to_account_metas(None));
        account_metas.extend(self.token_program.to_account_metas(None));
        account_metas.extend(self.system_program.to_account_metas(None));
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for InitWallet<'info>
where
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.escrow_wallet, program_id)
            .map_err(|e| e.with_account_name("escrow_wallet"))?;
        anchor_lang::AccountsExit::exit(&self.user_sending, program_id)
            .map_err(|e| e.with_account_name("user_sending"))?;
        Ok(())
    }
}
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_init_wallet {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`InitWallet`].
    pub struct InitWallet {
        pub escrow_wallet: anchor_lang::solana_program::pubkey::Pubkey,
        pub user_sending: anchor_lang::solana_program::pubkey::Pubkey,
        pub mint: anchor_lang::solana_program::pubkey::Pubkey,
        pub token_program: anchor_lang::solana_program::pubkey::Pubkey,
        pub system_program: anchor_lang::solana_program::pubkey::Pubkey,
        ...
        anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.escrow_wallet, writer)?;
            borsh::BorshSerialize::serialize(&self.user_sending, writer)?;
            borsh::BorshSerialize::serialize(&self.mint, writer)?;
            borsh::BorshSerialize::serialize(&self.token_program, writer)?;
            borsh::BorshSerialize::serialize(&self.system_program, writer)?;
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for InitWallet {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_init_wallet {
    use super::*;
    /// Generated CPI struct of the accounts for [`InitWallet`].
    pub struct InitWallet<'info> {
        pub escrow_wallet: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub user_sending: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub mint: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub token_program: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub system_program: anchor_lang::solana_program::account_info::AccountInfo<
            'info,
    ...
    impl<'info> anchor_lang::ToAccountMetas for InitWallet<'info> {
        fn to_account_metas(
            ...
            account_metas
                .push(
                    anchor_lang::solana_program::instruction::AccountMeta::new(
                        anchor_lang::Key::key(&self.escrow_wallet),
                        false,
                    ),
                );
            account_metas
                .push(
                    anchor_lang::solana_program::instruction::AccountMeta::new(
                        anchor_lang::Key::key(&self.user_sending),
                        true,
                    ),
                );
            account_metas
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for InitWallet<'info> {
        fn to_account_infos(
            ...
            let mut account_infos = ::alloc::vec::Vec::new();
            account_infos
                .push(anchor_lang::ToAccountInfo::to_account_info(&self.escrow_wallet));
            account_infos
                .push(anchor_lang::ToAccountInfo::to_account_info(&self.user_sending));
            account_infos.push(anchor_lang::ToAccountInfo::to_account_info(&self.mint));
            account_infos
                .push(anchor_lang::ToAccountInfo::to_account_info(&self.token_program));
            account_infos
